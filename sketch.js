...
thumb.scale=0.6
Loser=createSprite(displayWidth/2+420,displayHeight/2,39,40)
...
function draw() {
 ...
 if(gameState === "rules"){
   ...
   text("2: You have to kill zombies and score 75 points",200,300)
   text("3: There is a timer given beside the score whose value assigned will be 0.",200,350)
   text("4: If the timer reaches 5000 before you score 75 points then you will loose the game",200,400)
   ...
   fill(872,10,103)
   textSize(40)
   text("Himanshu Paul and Ritu Spall",1245,830)
   if(keyDown("down")){
     gameState = "play"
   }
 }
   ...
   textSize(50)
    text("Please press up arrow to shoot",500,910)
     ...
     console.log(timer)
     textSize(30);
     text("Score 75 points to win",1000,100)
  ...
  if(timer === 5000 && score<75 || vampireGroup.isTouching(Police) || zombieGroup.isTouching(Police) || zombiesGroup.isTouching(Police)){
    gameState="loose"
  }
